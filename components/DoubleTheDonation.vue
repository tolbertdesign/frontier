<template>
  <div class="max-w-sm max-w-xl mx-auto mb-16 text-lg text-left">
    ...
    <div class="mb-8 corp-list">
      <div>
        <span class="circle-number"><strong>1.</strong></span> Search for your
        employer below
      </div>
      <div>
        <span class="circle-number"><strong>2.</strong></span> Follow their
        instructions to submit this request
      </div>
      <div v-if="legalName !== 'Booster Enterprises'">
        <span class="circle-number"><strong>3.</strong></span> Use
        {{ legalName }} Federal Tax ID: {{ taxId }}
      </div>
    </div>
    ...
    <div id="dd-container" class="m-top-20">
      ...
      <a
        ...
        >Volunteer Grant</a
      >
      information provided by <br /><a href="https://doublethedonation.com"
        ><img
