...
$factory->state(App\Entities\Podcast::class, 'published', function (Faker $faker) {
    return [
        'published_at' => $faker->dateTimeBetween('-4 years'),
    ];
});

$factory->define(App\Entities\Episode::class, function (Faker $faker) {
    return [
        'podcast_id' => factory(App\Entities\Podcast::class)->lazy(),
        "number" => 68,
...
$factory->state(App\Entities\Episode::class, 'published', function (Faker $faker) {
    return [
        'published_at' => $faker->dateTimeBetween('-4 years'),
    ];
});
