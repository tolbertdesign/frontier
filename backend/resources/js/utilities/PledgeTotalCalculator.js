import { STATUS_CONFIRMED, STATUS_PAID, STATUS_PAYMENT_SCHEDULED, PLEDGE_TYPE_FLAT } from '@/store/modules/pledge.js'
...
class PledgeTotalCalculator {
  ...
  constructor (program, pledges, statusIds = undefined) {
    ...
    this.statusIds = typeof (statusIds) !== 'undefined' ? statusIds : [
      STATUS_CONFIRMED,
      STATUS_PAID,
  ...
  getTotalAsFlat () {
    const flatAmountExtractor = (pledge) => pledge.pledge_type_id === PLEDGE_TYPE_FLAT ? pledge.amount : pledge.amount * this.program.unit_flat_conversion
